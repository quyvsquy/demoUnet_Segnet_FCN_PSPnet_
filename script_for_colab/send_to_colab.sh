...
PORT=$1
IP=$2
sshpass -p 123456 scp -o StrictHostKeyChecking=no -P $PORT auto_deploy_colab.sh  root@$IP.tcp.ngrok.io:"/content/gdrive/My\ Drive/HKVI/CS431_CacKyThuatHocSauVaUngDung"
